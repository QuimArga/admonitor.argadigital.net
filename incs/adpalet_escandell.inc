<!-- CAPÇALERES I LINIES ADPALET ESCANDELL -->     
<?php
// AdPalet ESCANDELL
$conn = ftp_connect('escandell.argadigital.net', 21);
$result = ftp_login($conn, 'sel7461', 'ViaCannetum2');
