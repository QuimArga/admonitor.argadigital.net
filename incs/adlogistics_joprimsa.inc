<!-- CAPÇALERES I LINIES ADLOGISTICS JOPRIMSA -->     
<?php
// Adlogistics Joprimsa
$conn = ftp_connect('joprimsa.adlogistics.net', 21);
$result = ftp_login($conn, 'sel3365', 'Joprimsa23');
